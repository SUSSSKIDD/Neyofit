...
const cspDirectives = [
    ...
    "img-src 'self' data: https: blob: https://maps.googleapis.com https://maps.gstatic.com https://lh3.googleusercontent.com https://*.googleusercontent.com https://*.ggpht.com https://maps.googleapis.com/maps/api/mapsjs/gen_204",
